    ...
    >
      <Container className="flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          <Link
            href="/"
            className="text-2xl font-extrabold text-primary-600 transition-transform hover:scale-105"
          >
            Pedily
          </Link>
        ...
        {isDocs ? (
          ...
          <>
            ...
            <div className="hidden items-center gap-3 md:flex">
              <a
                href="#precios"
                className="rounded-lg px-4 py-2 text-sm font-medium text-slate-600 transition-all hover:bg-slate-100 hover:text-primary-600"
              >
                Ver precios
              </a>
              <a
                href="#cta"
                className="rounded-lg bg-primary-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-primary-500/20 transition-all hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-500/30 active:scale-95"
              >
                Empieza gratis
              </a>
            </div>
            ...
            >
              <Container className="flex flex-col gap-1 py-4">
                ...
                <motion.a
                  ...
                  className="mt-2 rounded-lg bg-primary-600 px-5 py-2.5 text-center text-sm font-semibold text-white"
                  onClick={() => setMobileOpen(false)}
                >
                  Empieza gratis
                </motion.a>
